...
console.log(coursesAndDurationArray.map((course, index) => ({...course,title: index + 1})));

console.log(coursesAndDurationArray.map((course, index) => ({...course,monthDuration: index + 1})));
